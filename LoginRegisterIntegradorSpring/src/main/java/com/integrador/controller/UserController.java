...
import com.integrador.form.UserForm;
import com.integrador.model.UserInfo;
import com.integrador.service.UserService;
import com.integrador.validator.SignupValidator;
...
public class UserController {
	...
	public ModelAndView save(@ModelAttribute("user") UserInfo user) {
		...
		model.addObject("msg","Password cambiado satisfactoriamente");
	...
	public String register(@ModelAttribute("userForm")UserForm userForm, BindingResult result, RedirectAttributes redirectAttributes) {
		signupValidator.validate(userForm, result);
			if(result.hasErrors() ) {
				...
				redirectAttributes.addFlashAttribute("msg", "Se ha creado su cuenta correctamente");
